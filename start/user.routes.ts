...
router.group(() => {
  ...
  router.post('/apps/permissions', [PermissionsController, 'createUserPermissions']).use(middleware.authenticate())
  router.get('/apps/permissions', [PermissionsController, 'getUserPermissions']).use(middleware.authenticate())
